...
export class CoreConfigConstants {
    ...
    static customurlscheme = 'moodle-app-agro';
    static siteurl = 'universidadagro.com.mx';
    static sitename = '';
    ...
    static appstores: any = {
        android: 'com.universidad.agro.anima',
        ios: 'id633359593',
        windows: 'moodle-desktop/9p9bwvhdc8c8',
        mac: 'id1255924440',
        linux: 'https://download.moodle.org/desktop/download.php?platform=linux&arch=64',
    };
    static compilationtime = 1620784953243;
    static lastcommit = 'fd584449974a2d058f4fc80e9c17a425912cae49';
}
